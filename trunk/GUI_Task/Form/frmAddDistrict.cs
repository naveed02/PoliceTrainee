...
namespace GUI_Task
{
    public partial class frmAddDistrict : Form
    {
        ...
        private void frmAddDistrict_Load(object sender, EventArgs e)
        {
            this.MaximizeBox = false;
        }

        private void frmAddDistrict_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
             SaveData();
            MessageBox.Show("District Added Successfullly");
        }
        ...
        private bool PrepareDocMaster()
        {
            ...
            try
            {
                ...
                {
                    fDocWhere = " cgCode = 2 AND cgdCode = " + txtCourseID.Text.ToString();
        ...
        private void PopulateRecords()
        {
            ...
            tSQL += " select cgdCode, cgdDesc AS District, Status";
            tSQL += " from CatDtl where cgCode = 2 AND cgdCode = " + txtCourseID.Text.ToString();
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    txtCourseName.Text = (ds.Tables[0].Rows[0]["District"] == DBNull.Value ? "" : ds.Tables[0].Rows[0]["District"].ToString());
