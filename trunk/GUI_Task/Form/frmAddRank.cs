...
namespace GUI_Task
{
    public partial class frmAddRank : Form
    {
        ...
        private void AddRank_Load(object sender, EventArgs e)
        {
            this.MaximizeBox = false;
        }

        private void AddRank_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private bool PrepareDocMaster()
        {
            ...
            try
            {
                ...
                {
                    fDocWhere = " cgCode = 4 AND cgdCode = " + txtRankID.Text.ToString();
        ...
        private void PopulateRecords()
        {
            ...
            tSQL += " select cgdCode, cgdDesc AS RankName, Status";
            tSQL += " from CatDtl where cgCode = 4 AND cgdCode = " + txtRankID.Text.ToString();
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    txtRankName.Text = (ds.Tables[0].Rows[0]["RankName"] == DBNull.Value ? "" : ds.Tables[0].Rows[0]["RankName"].ToString());
        ...
        private void txtRankName_DoubleClick(object sender, EventArgs e)
        {
            LookUp_Voc();
        }
