...
namespace GUI_Task
{
    public partial class frmAddAppRank : Form
    {
        ...
        public frmAddAppRank()
        {
            InitializeComponent();
        }

        private void frmAddNewAppRank_Load(object sender, EventArgs e)
        {
            this.MaximizeBox = false;
        }

        private void frmAddNewAppRank_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            SaveData();
            MessageBox.Show("Rank Added Successfullly");
        }
        ...
        private bool SaveData()
        {
            ...
            try
            {
                ...
                if (fManySQL.Count > 0)
                {
                    ...
                    {
                        fLastID = txtRankID.Text.ToString();
                        ClearThisForm();
                        return true;
                    }
                }
        ...
        private bool PrepareDocMaster()
        {
            ...
            try
            {
                if (txtRankID.Text.ToString().Trim(' ', '-') == "")
                {
                    strDocId = 0;
                    ...
                    //fDocID = fDocID + 1;
                    fDocWhere = "cgCode = 14";
                    txtRankID.Text = fDocID.ToString();
                    ...
                    lSQL += ",'" + txtRankName.Text.ToString() + "'";
                ...
                {
                    fDocWhere = " cgCode = 14 AND cgdCode = " + txtRankID.Text.ToString();
                    ...
                    lSQL += " cgdDesc = '" + txtRankName.Text.ToString() + "'";
        ...
        private void txtRankID_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void txtRankID_DoubleClick(object sender, EventArgs e)
        {
            LookUp_Voc();
        }
        ...
        private void LookUp_Voc()
        {
            ...
            if (txtRankID.Text != null)
            {
                if (txtRankID.Text != null)
                {
                    if (txtRankID.Text.ToString() == "" || txtRankID.Text.ToString() == string.Empty)
                    {
                        return;
                    }
                    if (txtRankID.Text.ToString().Trim().Length > 0)
                    {
                        PopulateRecords();
                    }
        ...
        {
            txtRankID.Text = ((TextBox)sender).Text;
        }
        ...
        private void PopulateRecords()
        {
            ...
            tSQL += " select cgdCode, cgdDesc AS AppRankName, Status";
            tSQL += " from CatDtl where cgCode = 14 AND cgdCode = " + txtRankID.Text.ToString();
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    txtRankID.Text = (ds.Tables[0].Rows[0]["cgdCode"] == DBNull.Value ? "" : ds.Tables[0].Rows[0]["cgdCode"].ToString());
                    txtRankName.Text = (ds.Tables[0].Rows[0]["AppRankName"] == DBNull.Value ? "" : ds.Tables[0].Rows[0]["AppRankName"].ToString());
